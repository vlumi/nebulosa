...
- Places: several pins, added with a double click or a long press on the map and named after the nearest place label the map is showing, dragged to move or locked against stray drags, renamed or removed in their sheet, kept in the browser. One is selected at a time, or none.
