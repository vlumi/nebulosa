...
test('a pointer click on a button or slider releases focus; a keyboard activation keeps it', () => {
  ...
  slider.focus()
  slider.dispatchEvent(new MouseEvent('click', { detail: 1, bubbles: true }))
